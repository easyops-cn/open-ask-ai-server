...
nav/eo-nav-menu/basic
# -- YAML HEADING DELIMITER end (1nbbm8) --
# -- YAML DELIMITER (1nbbm8) --
# <eo-nav-menu id="brick-1"></eo-nav-menu>
# <div></div>
# <eo-nav-menu id="brick-2"></eo-nav-menu>
# 
# <script>
          ...
          - title: 测试组
            ...
            items:
              ...
              - text: 构件
                ...
                type: default
# -- YAML HEADING DELIMITER start (1nbbm8) --
nav/eo-nav-menu/overflow
# -- YAML HEADING DELIMITER end (1nbbm8) --
# -- YAML DELIMITER (1nbbm8) --
# <eo-nav-menu style="width: 100px" id="brick-1"></eo-nav-menu>
# 
# <script>
#   const brick_1 = document.getElementById("brick-1");
#   brick_1.menu = {
...
#               {
#                 activeExcludes: [],
#                 activeIncludes: ["/storage-resource-monitor/cbs/:path+"],
#                 activeMatchSearch: false,
#                 defaultExpanded: false,
#                 exact: false,
#                 icon: {
...
<TypeReferencesContext.Provider value={[]}>
  <BrickDocProperties properties={[{"name":"menu","description":"菜单项","attribute":false,"type":"SidebarMenu","annotation":{"type":"reference","typeName":{"type":"identifier","name":"SidebarMenu"}}},{"name":"mainMenuTitleStyle","attribute":false,"type":"CSSProperties","annotation":{"type":"reference","typeName":{"type":"identifier","name":"CSSProperties"}}},{"name":"showTooltip","description":"是否显示 tooltip","type":"boolean","annotation":{"type":"keyword","value":"boolean"}}]} />
